...
import (
	...
	"github.com/hybridapp-io/ham-application-assembler/pkg/apis"
	"github.com/hybridapp-io/ham-application-assembler/pkg/controller"
	"github.com/hybridapp-io/ham-application-assembler/version"
...
func RunManager(sig <-chan struct{}) {
	...
	err = leader.Become(ctx, "ham-application-assembler-lock")
	if err != nil {
		klog.Error(err, "")
		os.Exit(errorExitCode)
	}
